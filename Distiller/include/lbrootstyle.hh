...
inline void SetLBStyle() {
  ...
  lbStyle->SetPadLeftMargin(
      0.16); // Spazio per il titolo asse Y (evita sovrapposizioni)
  ...
  lbStyle->SetStripDecimals(
      kFALSE); // Mantiene l'allineamento (es. 1.0, 1.5, 2.0)
  ...
  lbStyle->SetEndErrorSize(
      0); // Niente sbarrette orizzontali agli estremi degli errori
  ...
  std::cout << " [lbStyle] Lorenzo's Publication Style successfully loaded!"
            << std::endl;
}
